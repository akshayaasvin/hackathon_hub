...
export default function CollegeStudentsPage() {
  ...
  if (loading) {
    return <div style={{ padding: '100px 20px', textAlign: 'center', fontSize: '18px', color: 'var(--text-secondary)' }}>Loading Student Directory...</div>
  }
  ...
  return (
    <div className="premium-container fade-in" style={{ padding: '40px' }}>
      <div style={{ marginBottom: '36px' }}>
        <h1 style={{ fontSize: '32px', marginBottom: '8px', fontFamily: 'var(--font-display)' }}>Registered Students</h1>
        <p style={{ color: 'var(--text-secondary)' }}>Directory of your institution's students and their hackathon progress.</p>
      </div>
